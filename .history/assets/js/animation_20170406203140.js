    ...
    runAnimationScene1: function()
    {
        ...
        home_donald.on('start', function(){
            ...
            donaldLeavingTween.to($('#homeDonald'), 0.3, { opacity: 0 })
                        ...
                        .to(homeCar, 2, { x: vwUnit(-60) });
        
            var donaldLeavingScene = new ScrollMagic.Scene({triggerElement: '#carTop', triggerHook: 0, duration: vwUnit(30)})
...
$(document).ready(function(){
    christmasStory.init();
    $('.cityRoad .innerBlk').width( $('.cityRoad .bg-grass').width() );
});
