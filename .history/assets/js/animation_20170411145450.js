...
var christmasStory = {
    ...
    runAnimationScene2: function()
    {
        var cityCarTween = new TimelineMax();
            cityCarTween.to($('.cityRoad .bg-grass'), 1, { x: vwUnit(132), ease: Power2.easeOut }, 0)
                        .to($('.cityRoad .orangeCar'), 1, { x: vwUnit(176), ease: Power2.easeOut }, 0)
                        .to($('.cityRoad .roadBg'), 1, { x: vwUnit(112), ease: Power2.easeOut }, 0)
                        .to($('.cityRoad .buildingsRow'), 1, { x: vwUnit(92), ease: Power2.easeOut }, 0)
                        .to($('.skyWheel, .carouselWheel'), 1, { x: vwUnit(80), ease: Power2.easeOut }, 0)
                        .to($('.airbaloon'), 1, { x: vwUnit(68), ease: Power2.easeOut }, 0)
                        .to($('.cityRoad .hills.main, .cityRoad .hills.reversed'), 1, { x: vwUnit(52), ease: Power2.easeOut }, 0)
                        .to($('.cityRoad .donaldCar'), 1, { x: vwUnit(-90), ease: Power2.easeOut }, 0)
                        .to($('.cityRoad .blueCar'), 1, { x: vwUnit(216), ease: Power2.easeOut }, 0)
                        ;
