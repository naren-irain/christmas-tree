...
var christmasStory = {
    ...
    hideDialog: function(dialogElement)
    {
        // Create Dialog Tween
        var dialog = document.querySelector(dialogElement),
        ...
        showDialog.staggerFromTo([bubble1, bubble2, mainBubble], 0.4, {opacity: 1, scale: 1}, {opacity: 0, scale: 0}, 0.1)
            .fromTo(dialogText, 0.3, {opacity: 1}, {opacity: 0})

        // Display Dialog
        var scene = new ScrollMagic.Scene().setTween(hideDialog);
        return scene;
    },
    ...
    runAnimationScene1: function()
    {
        ...
        var hide_home_dialog2 = christmasStory.hideDialog('#dialog_2');
