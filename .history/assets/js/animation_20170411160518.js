...
var christmasStory = {
    ...
    showDialog: function(dialogElement, triggerElement)
    {
        ...
        showDialog.staggerFromTo([bubble1, bubble2, mainBubble], 0.4, {opacity: 0, scale: 0}, {opacity: 1, scale: 1}, 0.1)
            ...
            .to(dialogText, 0.3, {opacity: 0}, 3)
            .staggerTo([bubble1, bubble2, mainBubble], 0.4, {opacity: 0, scale: 0}, 3.1)
    ...
    runAnimationScene2: function()
    {
        ...
        cc_dialog1.addTo(christmasStory.controller);

        var cc_dialog2   = christmasStory.showDialog('#cc_dialog2', '#cc_dialog2_top');
        cc_dialog2.addTo(christmasStory.controller);
        
        var cc_dialog3   = christmasStory.showDialog('#cc_dialog3', '#cc_dialog3_top');
        cc_dialog3.addTo(christmasStory.controller);
        ...
        var cityCarTween = new TimelineMax();
            cityCarTween.to($('.cityRoad .bg-grass'), 2, { x: vwUnit(128), ease: Power2.easeOut }, 0)
                        ...
                        .to($('.airbaloon'), 2, { x: vwUnit(68), ease: Power2.easeOut }, 0)
