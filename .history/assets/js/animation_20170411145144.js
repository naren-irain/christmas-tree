...
var christmasStory = {
    ...
    runAnimationScene2: function()
    {
        var cityCarTween = new TimelineMax();
            cityCarTween.to($('.cityRoad .bg-grass'), 1, { x: vwUnit(132) }, 0)
                        .to($('.cityRoad .orangeCar'), 1, { x: vwUnit(176) }, 0)
                        .to($('.cityRoad .roadBg'), 1, { x: vwUnit(112) }, 0)
                        .to($('.cityRoad .buildingsRow'), 1, { x: vwUnit(92) }, 0)
                        .to($('.skyWheel, .carouselWheel'), 1, { x: vwUnit(80) }, 0)
                        .to($('.airbaloon'), 1, { x: vwUnit(68) }, 0)
