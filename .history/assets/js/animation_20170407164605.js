...
var christmasStory = {
    ...
    runAnimationScene2: function()
    {
        ...
        /* var ol = new ScrollMagic.Scene({
            triggerElement: '.cityRoad',
            triggerHook: 'onLeave'
        })
        .setPin('.cityRoad')
        .addTo(christmasStory.controller); */

        var scene = new ScrollMagic.Scene({triggerElement: ".cityRoadSpace", triggerHook: -0.1, duration: vwUnit(266)})
                        .setPin(".cityRoadContainer")
                        .addTo(christmasStory.controller);

        /*var stickBgOnCityRoad   = christmasStory.pinElement('.cityRoadContainer', '.cityRoadSpace', 266);
        christmasStory.controller.addScene([stickBgOnKids]);*/
    }
