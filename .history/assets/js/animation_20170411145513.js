...
var christmasStory = {
    ...
    runAnimationScene2: function()
    {
        var cityCarTween = new TimelineMax();
            cityCarTween.to($('.cityRoad .bg-grass'), 4, { x: vwUnit(132), ease: Power2.easeOut }, 0)
                        .to($('.cityRoad .orangeCar'), 4, { x: vwUnit(176), ease: Power2.easeOut }, 0)
                        .to($('.cityRoad .roadBg'), 4, { x: vwUnit(112), ease: Power2.easeOut }, 0)
                        .to($('.cityRoad .buildingsRow'), 4, { x: vwUnit(92), ease: Power2.easeOut }, 0)
                        .to($('.skyWheel, .carouselWheel'), 4, { x: vwUnit(80), ease: Power2.easeOut }, 0)
                        .to($('.airbaloon'), 4, { x: vwUnit(68), ease: Power2.easeOut }, 0)
                        .to($('.cityRoad .hills.main, .cityRoad .hills.reversed'), 4, { x: vwUnit(52), ease: Power2.easeOut }, 0)
                        .to($('.cityRoad .donaldCar'), 4, { x: vwUnit(-90), ease: Power2.easeOut }, 0)
                        .to($('.cityRoad .blueCar'), 4, { x: vwUnit(216), ease: Power2.easeOut }, 0)
                        ;
