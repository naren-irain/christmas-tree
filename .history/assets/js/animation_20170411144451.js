...
var christmasStory = {
    ...
    runAnimationScene1: function()
    {
        ...
        home_donald.on('start', function(){
            ...
            donaldLeavingTween.fromTo($('#homeDonald'), 0.3, {opacity: 1}, { opacity: 0 }, 0)
    ...
    runAnimationScene2: function()
    {
        var cityCarTween = new TimelineMax();
            cityCarTween.to($('.cityRoad .bg-grass'), 2, { x: vwUnit(132) }, 0)
                        .to($('.cityRoad .orangeCar'), 2, { x: vwUnit(176) }, 0)
                        .to($('.cityRoad .roadBg'), 2, { x: vwUnit(112) }, 0)
                        .to($('.cityRoad .buildingsRow'), 2, { x: vwUnit(92) }, 0)
                        .to($('.skyWheel, .carouselWheel'), 2, { x: vwUnit(80) }, 0)
                        .to($('.airbaloon'), 2, { x: vwUnit(68) }, 0)
                        .to($('.cityRoad .hills.main, .cityRoad .hills.reversed'), 2, { x: vwUnit(52) }, 0)
                        .to($('.cityRoad .donaldCar'), 2, { x: vwUnit(-90) }, 0)
                        .to($(), 2, { x: vwUnit(216) }, 0)
                        .to($('.cityRoad .blueCar'), 2, { x: vwUnit(216) }, 0)
                        ;
